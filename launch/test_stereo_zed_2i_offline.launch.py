...
def generate_launch_description():
    ...
    local_image_path_arg = DeclareLaunchArgument(
        "local_image_path", default_value="/root/zhikang.zeng/helloros_ws/zed-2i-meeting-room-20241009-img-split", description="local image path"
    )
    ...
    stereonet_node = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            "camera_fy": "514.5878861678406",
            "camera_cx": "665.3764572143555",
            "camera_cy": "320.3872646755642",
            "base_line": "0.119893",
